...
[source,console]
---- 
[nick@localhost ~]$ shopt login_shell
login_shell    	on
[nick@localhost ~]$ 
[nick@localhost ~]$ bash -c 'shopt login_shell'
login_shell    	off
[nick@localhost ~]$ 
----
...
[source,console]
---- 
[nick@localhost ~]$ echo $0
-bash
[nick@localhost ~]$ 
[nick@localhost ~]$ bash -c 'echo $0'
bash
[nick@localhost ~]$ 
----
